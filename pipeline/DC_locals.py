...
_s4p      = './'        # the S4P scripts directory

_s4p_data = './data/'   # the S4P data directory, should be read only from here!
_s4p_work = './work/'   # the S4P work directory, you can write here!
...
print("Setup of /media/francesca/data/AtLAST/AtLAST_simulations complete for python3 only")
print("S4P_DATA = /media/francesca/data/AtLAST/AtLAST_simulations/data (read only)")
print("S4P_WORK = /media/francesca/data/AtLAST/AtLAST_simulations/work (read/write)")
