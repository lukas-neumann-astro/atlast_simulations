...
def get_IQA_nomask(ref_image = '',target_image=[''], pb_image=None, masking_RMS=None, 
            target_beam_index=0): #, pbval=0.2):
    ...
    for j in np.arange(0,np.shape(target_image)[0],1):
        ...
        # export into FITS
        os.system('rm -rf '+target_image[j] + "_convo2ref*.fits")
        exportfits(imagename=target_image[j] + "_convo2ref",fitsimage=target_image[j] + "_convo2ref_nomask.fits",dropdeg=True)
        print(" See results in " +target_image[j] + "_convo2ref* images")
        print("---------------------------------------------")
    print(" IQA estimators... DONE")
    print("=============================================")
